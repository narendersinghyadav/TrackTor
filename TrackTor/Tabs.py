...
from TrackTor.Utilities.dna import get_info_relay
...
import calendar
import sys
from TrackTor.Utilities.dna import get_fingerprint,get_network_status
...
class _Tabs():
        ...
        def _Relay_Info(self):
            ...
            def _Node_Details(fingerprint):
                ...
                router_status_entry = get_network_status(fingerprint)
                ...
                try:
                	...
                	Published = 'Published : ' + str(router_status_entry["published"])
            ...
            def _Display_Fingerprint():
                if (not Configurations.is_alive()):
                    ...
                    if (self.Type == 'Circuit'):
                        ...
                        if (self.Display_Address.split(':')[0] == get_info_relay('address')):
                            self.Display_Fingerprint = get_fingerprint()
